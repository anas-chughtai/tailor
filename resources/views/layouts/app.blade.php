...
<head>
    ...
    <meta name="author" content="BINARY PROGRAMMERS">

    <!-- App favicon -->
    <link rel="shortcut icon" href="assets/images/favicon.ico">
    <!-- App title -->
    <title>@yield('title') | BT Designs</title>
...
<div id="wrapper">
    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <a href="" class="logo">
                        <span>
                            <img src="{{ asset('images/lily-logo-min.png') }}" alt="" width="180" class="">
                        </span>
                <i>
                    <img src="{{ asset('images/seasor.jpg') }}" alt="" class="thumb-md ">
                </i>
            </a>
        </div>
        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li class="has_sub">
                        <a href="{{ route('dashboards.index') }}" class="waves-effect"><i
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-account-multiple"></i>
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-tag-text-outline"></i>
                            <span> Sizes </span> <span class="menu-arrow"></span></a>
                        <ul class="list-unstyled">
                            <li><a href="{{ route ('sizes.create') }}">Add Sizes</a></li>
                            <li><a href="{{ route ('sizes.index') }}">Sizes List</a></li>
                        </ul>
                    </li>
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-shopping"></i>
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-cash-multiple"></i> <span> Salary </span>
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-settings"></i> <span> Profile </span>
                            <span class="menu-arrow"></span></a>
                        <ul class="list-unstyled">
    ...
    <div class="content-page">
        ...
        <footer class="footer text-right">
            {{date('Y')}} © <span class="text-danger">BT Designs v1.1.</span>
            <span class="pull-right">
                        <i class="fa fa-heart text- text-danger"></i> by <span
                        class="text-danger">BINARY PROGRAMMERS</span>
                    </span>
        </footer>
